...
**Shelter**: The hollow beneath the root ball is real. It is cramped — two people, maybe three — but dry and hidden. Someone has been here before: a small ring of stones that once held a fire, now cold and overgrown. The ash beneath the stones, if disturbed (Survival DC 11), is old. Years, not months.

**The Hollow**: There is a gap in the underside of the trunk about thirty feet from the root end — bark that has rotted away, exposing a hollow interior large enough to crawl into. It goes back about six feet and then closes. It is empty. It smells faintly of something that lived here and doesn't anymore. Claws marks on the inner wood (Nature DC 13): a bear, and not a small one. The marks are old.

**Encounters**: The Elder's open zone is the most visible clearing in the Northern Tract. Anything that wants to see the road without being on it will use the treeline here. This is a good place for that glimpse of movement players were warned about at the sign — just at the edge of the light, there for a moment and then gone.

**Scale**: The tree is genuinely enormous. If players attempt to climb the root wall or walk the length of the trunk, let them. It takes longer than it looks.`,
};
