export const primroseAmphitheater = {
  id: "primrose-amphitheater",
  name: "PrimRose Amphitheater",
  image: "/primrose-amphitheater.jpg",
  tagline: "Where the Garden District performs for itself.",
  path: "/beacon/garden-district/primrose-amphitheater",

  sceneDescription: `At the far end of the Garden District, where the two ring roads bend toward each other and meet, the PrimRose Amphitheater sits sunken into the ground.
...
The theater is open to the public. There is no gate, no ticketing, no guard at the entrance. The Garden District simply built it, and now it is here.`,
  ...
  dmNotes: `The PrimRose Amphitheater has no permanent staff and no scheduled programming — the Garden District funds it as a shared space. Performers apply to use it. Most are approved.
  ...
  connections: [
    {
      name: "Hydrangea Way",
      direction: "Left road",
      description: "The ring road bends left from the amphitheater down Hydrangea Way and its boutiques.",
      status: "live",
