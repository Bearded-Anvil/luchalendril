      ...
      <div className="max-w-5xl mx-auto px-6 py-12">
        ...
        <div className="mt-6 pt-6" style={{ borderTop: "1px solid rgba(201,168,76,0.15)" }}>
          <div className="grid grid-cols-2 gap-3">
            ...
            <a href="/beacon/home-hearth-district" style={{ color: "var(--gold)", textDecoration: "none", fontWeight: "700", border: "1px solid rgba(201,168,76,0.4)", padding: "0.5rem 1.1rem", display: "block", textAlign: "center", fontSize: "0.875rem" }}>
