...
import { splittingHairs } from "@/data/splitting-hairs";

export default function SplittingHairsPage() {
  const v = splittingHairs;
  ...
  return (
    <main className="min-h-screen" style={{ background: "#0f0d0a" }}>
      <div className="max-w-5xl mx-auto px-6 py-12">
        ...
        <div className="mt-8">
          <h2 className="text-xs uppercase tracking-widest mb-2" style={{ color: "var(--gold)", letterSpacing: "0.2em" }}>Blades & Axes</h2>
          <p className="text-xs italic mb-6" style={{ color: "var(--parchment)", opacity: 0.45 }}>
            Plain steel or something with an edge to it. Your call.
          </p>
