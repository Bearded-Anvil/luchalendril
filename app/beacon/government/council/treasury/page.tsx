...
import { gillyRoundtree } from "@/data/gilly-roundtree";

export default function GillyRoundtreePage() {
  const v = gillyRoundtree;
        ...
        <div className="mt-8 mb-10">
          ...
          {dmOpen && (
            <div className="dm-private p-6" style={{ borderTop: "none" }}>
              ...
              <p className="text-xs uppercase tracking-widest mb-2" style={{ color: "#e88080", opacity: 0.7, letterSpacing: "0.15em" }}>Who He Is Protecting</p>
              <p className="text-sm leading-relaxed mb-6" style={{ color: "var(--parchment)", opacity: 0.9 }}>{v.dmPrivate.whoHeIsProtecting}</p>

              <p className="text-xs uppercase tracking-widest mb-2" style={{ color: "#e88080", opacity: 0.7, letterSpacing: "0.15em" }}>Why He Does It</p>
              <p className="text-sm leading-relaxed mb-6" style={{ color: "var(--parchment)", opacity: 0.9 }}>{v.dmPrivate.whyHeDoesIt}</p>

              <p className="text-xs uppercase tracking-widest mb-2" style={{ color: "#e88080", opacity: 0.7, letterSpacing: "0.15em" }}>His Actual Danger</p>
              <p className="text-sm leading-relaxed mb-6" style={{ color: "var(--parchment)", opacity: 0.9 }}>{v.dmPrivate.hisActualDanger}</p>
