...
import { lucyndraRavenflight } from "@/data/lucyndra-ravenflight";

export default function LucyndraRavenflightPage() {
  const v = lucyndraRavenflight;
        ...
        <div className="mt-8 mb-10">
          ...
          {dmOpen && (
            <div className="dm-private p-6" style={{ borderTop: "none" }}>
              <p className="text-xs uppercase tracking-widest mb-2" style={{ color: "#e88080", opacity: 0.7, letterSpacing: "0.15em" }}>What She Came For</p>
              <p className="text-sm leading-relaxed mb-6" style={{ color: "var(--parchment)", opacity: 0.9 }}>{v.dmPrivate.whatSheCameFor}</p>

              <p className="text-xs uppercase tracking-widest mb-2" style={{ color: "#e88080", opacity: 0.7, letterSpacing: "0.15em" }}>The Bargain with Le&apos;Tarn</p>
              <p className="text-sm leading-relaxed mb-6" style={{ color: "var(--parchment)", opacity: 0.9 }}>{v.dmPrivate.theBargainWithLeTarn}</p>

              <p className="text-xs uppercase tracking-widest mb-2" style={{ color: "#e88080", opacity: 0.7, letterSpacing: "0.15em" }}>Her Skin, Her Staff, Her Past</p>
              <p className="text-sm leading-relaxed mb-6" style={{ color: "var(--parchment)", opacity: 0.9 }}>{v.dmPrivate.herSkinHerStaffHerPast}</p>

              <p className="text-xs uppercase tracking-widest mb-2" style={{ color: "#e88080", opacity: 0.7, letterSpacing: "0.15em" }}>What She Actually Knows</p>
              <p className="text-sm leading-relaxed mb-6" style={{ color: "var(--parchment)", opacity: 0.9 }}>{v.dmPrivate.whatSheActuallyKnows}</p>
