...
import { christopherPallo } from "@/data/christopher-pallo";

export default function ChristopherPalloPage() {
  const v = christopherPallo;
        ...
        <div className="mt-8 mb-10">
          ...
          {dmOpen && (
            <div className="dm-private p-6" style={{ borderTop: "none" }}>
              <p className="text-xs uppercase tracking-widest mb-2" style={{ color: "#e88080", opacity: 0.7, letterSpacing: "0.15em" }}>The Honest Man</p>
              <p className="text-sm leading-relaxed mb-6" style={{ color: "var(--parchment)", opacity: 0.9 }}>{v.dmPrivate.theHonestMan}</p>

              <p className="text-xs uppercase tracking-widest mb-2" style={{ color: "#e88080", opacity: 0.7, letterSpacing: "0.15em" }}>What He Knows</p>
              <p className="text-sm leading-relaxed mb-6" style={{ color: "var(--parchment)", opacity: 0.9 }}>{v.dmPrivate.whatHeKnows}</p>

              <p className="text-xs uppercase tracking-widest mb-2" style={{ color: "#e88080", opacity: 0.7, letterSpacing: "0.15em" }}>The Contracts</p>
              <p className="text-sm leading-relaxed mb-6" style={{ color: "var(--parchment)", opacity: 0.9 }}>{v.dmPrivate.theContracts}</p>

              <p className="text-xs uppercase tracking-widest mb-2" style={{ color: "#e88080", opacity: 0.7, letterSpacing: "0.15em" }}>The Assassination Warning</p>
              <p className="text-sm leading-relaxed mb-6" style={{ color: "var(--parchment)", opacity: 0.9 }}>{v.dmPrivate.theAssassinationWarning}</p>
