...
import { hydrangeaWay } from "@/data/hydrangea-way";

export default function HydrangeaWayPage() {
  const v = hydrangeaWay;
  ...
  return (
    <main className="min-h-screen" style={{ background: "#0f0d0a" }}>
      <div className="max-w-5xl mx-auto px-6 py-12">
        ...
        {/* Shops */}
        <div className="mt-8 mb-10">
          <h2 className="text-xs uppercase tracking-widest mb-2" style={{ color: "var(--gold)", letterSpacing: "0.2em" }}>The Shops</h2>
          <p className="text-xs italic mb-6" style={{ color: "var(--parchment)", opacity: 0.4 }}>Four boutiques along the row.</p>
