...
import { tobysCobblerShop } from "@/data/tobys-cobbler";

export default function TobysCobblerShopPage() {
  const v = tobysCobblerShop;
            ...
            <div className="p-6 space-y-5" style={{ background: "rgba(139,26,26,0.06)", border: "1px solid rgba(139,26,26,0.3)", borderTop: "none" }}>
              ...
              <div>
                ...
                <p className="text-xs mb-3 italic" style={{ color: "var(--parchment)", opacity: 0.6 }}>
                  Only offered to those who know the password. Never displayed openly.
                </p>
