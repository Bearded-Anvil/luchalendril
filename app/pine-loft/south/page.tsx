...
import { pineLoftSouth } from "@/data/pine-loft-south";

export default function PineLoftSouthPage() {
  const v = pineLoftSouth;
    ...
    <main className="min-h-screen" style={{ background: "#0f0d0a" }}>
      <div className="max-w-5xl mx-auto px-6 py-12">
        ...
        <div className="relative w-full mb-10 gold-border overflow-hidden" style={{ aspectRatio: "16/9" }}>
          <Image src={v.image} alt={v.name} fill style={{ objectFit: "cover" }} priority />
        </div>
        ...
        <div className="mt-16 pt-8 flex items-center justify-between" style={{ borderTop: "1px solid rgba(201,168,76,0.15)" }}>
          <a href="/pine-loft/north" style={{ textDecoration: "none" }}>
