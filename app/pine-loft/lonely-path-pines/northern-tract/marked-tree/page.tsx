...
import { lonelyPathMarkedTree } from "@/data/lonely-path-marked-tree";

export default function MarkedTreePage() {
  const v = lonelyPathMarkedTree;
    ...
    <main className="min-h-screen" style={{ background: "#0f0d0a" }}>
      <div className="max-w-5xl mx-auto px-6 py-12">
        ...
        <div className="mt-8 mb-10">
          ...
          >
            <span className="text-xs uppercase tracking-widest" style={{ color: "#e88080", letterSpacing: "0.2em" }}>DM — The Marked Tree</span>
