        ...
        <div className="mt-10 pt-8" style={{ borderTop: "1px solid rgba(201,168,76,0.15)" }}>
          <div className="flex items-start justify-between flex-wrap gap-6">
            ...
            <div style={{ textAlign: "right" }}>
              ...
              <p style={{ color: "var(--parchment)", opacity: 0.3, fontSize: "1rem", fontWeight: "700", border: "1px solid rgba(255,255,255,0.1)", padding: "0.5rem 1.1rem", display: "inline-block" }}>Southeast Tract →</p>
            </div>
          </div>
